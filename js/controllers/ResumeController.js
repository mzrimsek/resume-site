app.controller('ResumeController', ['$scope', function ($scope) {
  ...
  $scope.jobs = [
    ...
    new Job('Verys', 'CA', 'Junior Web Software Developer', 'January 2014', 'November 2015', 'http://verys.com', 'Verys - a boutique, custom software development company specializing in web and mobile applications - was recognized as one of the fastest growing companies in Orange County, CA.  I worked on several projects, but have presented the most notable ones below.', [
